...
! function(a, b, c, d) {
    ...
    var f = "dateDropdowns",
        g = { defaultDate: null, defaultDateFormat: "yyyy-mm-dd", displayFormat: "dmy", submitFormat: "yyyy-mm-dd", minAge: 0, maxAge: 120, minYear: null, maxYear: null, submitFieldName: "date", wrapperClass: "date-dropdowns", dropdownClass: null, daySuffixes: !0, monthSuffixes: !0, monthFormat: "long", required: !1, dayLabel: "Jour", monthLabel: "Mois", yearLabel: "Année", monthLongValues: ["Janv", "Fev", "Mars", "Avr.", "May", "Juin", "Juil.", "Aout", "Sep.", "Oct.", "Nov.", "Dec."], monthShortValues: ["Janv", "Fev", "Mars", "Avr.", "May", "Juin", "Juil.", "Aout", "Sep.", "Oct.", "Nov.", "Dec."], initialDayMonthYearValues: ["Jour", "Mois", "Année"], daySuffixValues: ["", "", "", ""] };
